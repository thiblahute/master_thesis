...
imposé leurs technologies sur le marché sans s'occuper (ou presque) %de la possibilité de
%communiquer entre ces logiciels.  Cela oblige donc les utilisateurs
%après avoir choisi solution logiciel , de poursuivre dans ce même choix
%pour tous les logiciels de la même suite logiciel dans le processus de
post-production. % Les utilisateurs de ces suites de logiciels sont donc 
%très dépendants de leurs fournisseurs et nous pensons
...
\paragraph{}
%Ceci est le propre des``Logiciel Libres''
c'est à dire que% le code source n'est pas accessible et utilisable
%exclusivement par une l'entreprise éditrice, mais il est accessible par tous à
...
%souplesse à l'utilisateur principalement pour les raisons suivantes:
...
secteurs de l'informatique %quel que soit le type d'entreprise. Ils permettent
...
années avec un % taux de croissance de l'ordre 66% pour l'année 2008 selon zdnet
...
logiciels libres ont ou pourront avoir dans le secteur %professionnel de la production
audiovisuelle .

Pour cela, nous allons %essayer de connaitre les besoins de ces 
monteurs professionnels% en étudiant les fonctionnalités dont ils disposent
%dans les logiciels existants, mais aussi en les interviewant 
%en leur demandant de les évaluer.
%Il conviendra aussi de savoir si ces logiciels libres présentent un intérêt pour 
%le marché de l'édition professionnelle . Nous allons chercher à
savoir si les logiciels libres répondent, où pourront répondre dans
le futur, aux enjeux que %présentent les logiciels professionnels de montages vidéo non
...
mais aussi, les différentes technologies libres %qui existent et qui permettront de faire du
montage vidéo .
