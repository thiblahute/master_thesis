...
% Les questions que l'on doit suciter:
%   * Pourquoi voudrait-on utiliser des logiciels libres
%   * Quels avantages Approteraient t'il?
%   * Est ce que le logiciel libre est techniquement capable de répondre aux
%   attentes de pro?
%   * Comment des entreprise pourrai gagner de l'argent en dévellopant des
%   logiciels libres?
