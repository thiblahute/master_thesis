...
\begin{itemize} \setlength{\itemsep}{2mm}
  ...
  \item{Création d'un framework \index {framework}}
\end{itemize}
...
\begin{itemize} \setlength{\itemsep}{2mm}
  \item {Les développeurs n'ont pas la nécessité de penser
    en terme d'interface publique de programmation (API) \index  {API},
    et n'ont pas à garantir la stabilité de celle-ci. Cela
    a pour effet que la qualité de l'architecture
    risque de ne pas être optimale puisque la création d'API \index {API} oblige
