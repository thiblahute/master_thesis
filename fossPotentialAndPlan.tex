...
%à sa conception monolithique, les développeurs n'ont pas pris la peine
de dissocier ces deux parties qui sont conceptuellement complètement
différentes. %On s'aperçoit en lisant le code que c'est le bazar?
...
extern implémenté sous form de plugins. Certains sont implémentés
...
pu être développé au dessus du framework\index{framework} MLT
...
gestion des threads, des signaux\ldots De très nombreux projets de
logiciels libres l'utilisent, en particulier le projet d'interface
...
safe, c'est a dire que la mémoire partagée par les differents threads
...
que GStreamer étant une téchnologie très complexe, les développeurs
...
\begin{itemize}
  ...
  possibiliter
    ...
    à grace à la classe GstIntepollation}
...
Cette analyse porte sur les mailling listes officiel des différent
projets:
...
Tout d'abord le logiciel cinelerra est développé exclusivement
en interne par la société Heroine Virtual Ltd exclusivement en
interne en faisant des libérant leur code (code drops) de manière
bi-annuel en moyenne. Une communauté c'est formé autour de ce code,
et celle-ci développe ce code en incluant les changement d'héroïne
Ltd lorsque l'entreprise release son code. Cette communauté a appelé
la ca version du logiciel cinelerra-cv, et la version est très proche
de celle officiel.  L'entreprise aussi reprend la grande majorité du
temps les changements effectués par la communauté au fur et à mesure.
