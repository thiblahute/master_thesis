...
\subsection {Entreprise impliqué dans le développement de
MLT\index{MLT}}
...
\paragraph{}
On constate bien que le logiciel Cinelerra a su prendre une part de
marché chez les professionnel. Mais son manque d'ergonomie et le
fait qu'il ne soit soutenu que par deux entreprise (la communauté
...
\paragraph{}
Le fait que Kdenlive n'ai pas réussi à ce faire une place auprès des
...
fonctionnalité (bien que dans de nombreux cas, celui-ci peu dors et
...
maintenu et supporté par plusieurs entreprise. La communauté, bien que
petite, semble en capacité de maintenir le projet et le faire évolué
convenablement. Le soucis majeur concernant cette technologies est due
au fait qu'elle ne permet pas de faire de composition à proprement parler,
et ne peut pas prendre en charge l'accélération materiel pour ce faire.
