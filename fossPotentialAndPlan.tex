...
\begin{itemize}
  ...
  \item {frei0r: Framework minimalist multi-platform de création
    ...
    le flux vidéo n'est pas dans cette espace de couleur,%CE N'EST PAS
    CLAIR COMME EXPLICATION \glossary {name={espace colorimétrique},
    ...
    inconvénient de cette librairie %réside dans le fait que les effets
...
Wikipedia}} entre ces librairie et l'API\index{API} précédemment
...
s'agit de la plus petit unite de processus qui peu être execute par un
système d'exploitation. Il permette a un même ``programme'', processus
