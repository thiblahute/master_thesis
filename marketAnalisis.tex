...
\paragraph{Les Footages\index{footage}}
Les Footages\index{footage} correspondent à toutes les sources brutes qui ont été enregistrer
...
timeline\index{timeline} (ralentir où accélérer). Le time remapping est une technique avancé
...
\paragraph{Gestion des Footages\index{footage}}
Un logiciel d'édition vidéo doit permettre d'importer les Footages\index{footage} à partir
...
\subsection{Definition du concept d'édition timeline\index{timeline}}
\paragraph{}
La timeline\index{timeline}, est la partie de l'interface dans laquelle on va disposer les
différents clips. Il s'agit du concept de base de l'édition vidéo non-linéaire.
Dans le cadre de l'édition timeline\index{timeline}, quelques fonction sont absoluments
...
\paragraph{Gestion des in point et  out point des clips} %Should that be translated?
  ...
  redéfinir la longueur d'un clip dans la timeline\index{timeline}, en ne jouant pas le debut
...
timeline\index{timeline}, mixer plusieurs sources et ajouter des titres depend de cette
...
et la possibilité d'organiser l'immense quantité de Footages\index{footage} de manière efficace
...
choisissant chaque image depuis un tableau de frames \index{frame}).
...
\begin{itemize} \setlength{\itemsep}{2mm}
  \item{Organisation très avancée des Footages\index{footage}}
...
timeline\index{timeline}. Cette fonctionnalité est aussi utile dans le cadre de
...
\paragraph{Gestion avancée des Footages\index{footage}}
\paragraph{}
...
des Footages\index{footage}. Cela est en particulier vrai pour les films et les séries télévisées.
Dans ces types de production le nombre d'heures de Footages\index{footage} peut être très grand, et
le monteur doit dans un premier temps, établir une classification
des Footages\index{footage}. Le logiciel de montage doit, pour répondre aux besoins des monteurs,
...
\section{Visions du marché par les professionnels du montage}
  ...
  Apple a décidé de changer le workflow \index{workflow} des professionnels de l'édition vidéo
...
\section {Bilan}
  ...
  de ce dont les utilisateurs ont besoins. C'est en particulier
  pour cela, que l'ont peut se demander si l'utilisation de logiciels
  ouverts et édités par de nombreuses entreprises, pourrait prendre une
  place sur le marché, en offrant de nouvelles perspectives pour
  ...
  \paragraph{Possibilité d'adaptation aux besoins précis de l'entreprise:}
    ...
    spécialement adaptées aux besoins des l'entreprise.
    \subparagraph{ }
    Alors que dans le cadre de projets commerciaux, cela n'est possible que par l'entreprise éditrice.
    On peut cependant, même dans ce cadre-là,  modifier, ajouter des fonctionnalités grâce aux systèmes
    d'extension logicielle, mais la flexibilité offerte par ce système reste limitée à ce que la société éditrice
    veut bien mettre à disposition des développeurs externes. (En terme d'API \index{API}).


% PAD http://titanpad.com/0ZF7cBNb0u
