...
une seule entreprise (externe) . Les fonctionnalité %de ces logiciels visent à
répondre % à la majorité des besoins du marché, mais ils %ont de grandes
%difficultés pour s'adapter à des besoins spécififiques d'entreprises .
...
(développeur/designer):}
  ...
  \subparagraph{ }
   ...
   ces raisons %que Dreamworks, TF1 et bien
    d'autres %se sont mis à utiliser des logiciels libres.
