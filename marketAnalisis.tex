...
\subsection {Bilan}
  Au final nous constatons que, bien que le marché soit vaste et varié, à l'heure actuel que quelques logiciels
  permettent de répondre aux besoins la grande majorité des utilisateurs.

  On peut donc comprendre en quoi l'utilisation de logiciel libres offre de nouvelle perspective pour
  les professionnelles du montage vidéo:
  \begin{itemize}
    \item{Permet une plus grande autonomie vis-à-vis de développeur: grace à l'utilisation de logiciel libre,
      il est possible de garantir, et maintenir le logiciel en intern tout en profitant du fait que des
      personnes externe à l'entreprise, d'une part le développe, et d'autre part, le connaisse. Cela a pour
      conséquence que les coût sont très largement réduit en comparaison à ce qui est actuellement pratiqué
      chez Dreamworks et TF1}
    \item{Permet une communication direct entre les utilisateurs et les développeurs}
    \item{La gratuité, dans le cadre de petites structures est particulièrement intéressant}
    \item{La possibilité de faire de développement spécifiques est un gros avantage pour certaines entreprises}
  \end {itemize}
