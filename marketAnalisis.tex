...
%JE NE VOIS PAS DE DEFINITION... Définition de?
...
une seule entreprise (externe) a défini les fonctionnalité visant à
répondre aux besoins de la plus grande part du marché, mais qui ne
corresponde pas forcement à une réalité dans cadre d'un entreprise
précise.
...
(développeur/designer):}
  ...
  \subparagraph{ }
    ...
    et d'autre part, le connaissent. Cela a pour conséquence que les
    coûts sont très largement réduits tout en gardant un contrôle
    certain sur le développement du logiciel. Celà explique très
    probablement le raison qui ont poussés Dreamworks, TF1 et bien
    d'autres à utiliser des logiciels libres.
